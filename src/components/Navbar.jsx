        ...
        <>
            <div className="w-full flex justify-between items-center font-semibold">
                <div className="flex items-center gap-2">
                    <img className="w-8 bg-black p-2 rounded-xl cursor-pointer" src={assets.arrow_left} alt="left arrow" />
                    <img className="w-8 bg-black p-2 rounded-xl cursor-pointer" src={assets.arrow_right} alt="right arrow" />
                </div>
